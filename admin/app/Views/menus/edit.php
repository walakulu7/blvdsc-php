<style>
/* ==========================================================================
   Menu Edit Form Styles (matching Event Create)
   ========================================================================== */
...
<div class="menu-edit-container">
    ...
    <div class="menu-page-header">
        <div class="menu-page-header-left">
            ...
            <h1 class="menu-page-title">Edit Menu</h1>
        </div>
        
        <div class="menu-page-header-right">
            <button type="button" onclick="document.getElementById('deleteForm').submit();" class="menu-btn menu-btn-danger">
    ...
    <div class="menu-form-card">
        <form method="POST" action="<?= BASE_PATH ?>/menus/<?= $menu['id'] ?>" enctype="multipart/form-data" id="menuForm">
                ...
                <div class="menu-form-row">
                    <div class="menu-form-field">
                        ...
                        <input type="number" id="display_order" name="display_order" class="menu-form-input" 
                               value="<?= htmlspecialchars($menu['display_order']) ?>" min="0" required>
                        <p class="menu-help-text">
            ...
            <div class="menu-section">
                ...
                <div class="menu-form-field">
                    <label class="menu-form-label">Current Image</label>
                    <div class="menu-current-image">
                        <img src="<?= BASE_URL ?>/../<?= htmlspecialchars($menu['image_url']) ?>" 
                ...
                <div class="menu-form-field">
                    ...
                    <input type="file" id="image" name="image" class="menu-form-input" 
                           accept="image/jpeg,image/png,image/webp" onchange="previewMenuImage(event)">
                    <p class="menu-help-text">
                        Upload a new image to replace the current one, or leave empty to keep existing image.<br>
                        Max 10MB. Accepted formats: JPG, PNG, WEBP.<br>
                        Images will be automatically resized to 794×1123 pixels (A4 size).
                    </p>
                </div>
                
                <div id="menuImagePreview" style="display: none;">
                    <label class="menu-form-label">New Image Preview</label>
        ...
        <!-- Delete Form (Hidden) -->
        <form method="POST" action="<?= BASE_PATH ?>/menus/<?= $menu['id'] ?>/delete" id="deleteForm" 
