<?php
// BLVD Specialty Coffee - High Tea Reservation Form Handler
...
try {
    ...
    error_log('High Tea reservation error: ' . $e->getMessage());
    http_response_code(500);
    echo json_encode([
        'success' => false, 
        'message' => 'Sorry, there was an error processing your reservation. Please try again later.'
    ]);
}
?>
