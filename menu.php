...
@media (max-width: 768px) {
    ...
    .menu-sidebar {
        position: static;
        width: 100%;
        order: -1; /* Ensures sidebar appears first/on top */
    }
        ...
        <div class="blvd-container">
            <div style="max-width: 1200px; margin: 0 auto;">
                ...
                <div style="margin-top: 60px; text-align: center; color: #6b7280; font-size: 14px;">
                    ...
                    <div class="menu-container" style="display: flex; justify-content: center; gap: 16px; margin-top: 20px;">
                        <a href="<?php echo SOCIAL_INSTAGRAM; ?>" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; background: #2d2d2d; border-radius: 50%; transition: background 0.3s;">
                        ...
                        <a href="<?php echo SOCIAL_FACEBOOK; ?>" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; background: #2d2d2d; border-radius: 50%; transition: background 0.3s;">
                            <svg style="width: 20px; height: 20px; color: white;" fill="currentColor" viewBox="0 0 24 24">
