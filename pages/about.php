...
<div class="relative pt-24 pb-16 md:pb-24">
  ...
  <div class="absolute inset-0 z-0">
    <div 
      ...
      style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://images.unsplash.com/photo-1554118811-1e0d58224f24?q=80&w=2047&auto=format&fit=crop');">
    </div>
  </div>
  ...
  <section class="section-padding bg-white">
    <div class="blvd-container">
      <div class="max-w-3xl mx-auto">
        <h2 class="font-display text-3xl md:text-4xl font-light mb-8 text-center">Crafting Exceptional Coffee Experiences</h2>
        ...
        <div class="prose prose-lg mx-auto">
          ...
          <div class="my-10">
            <img 
              src="https://images.unsplash.com/photo-1442512595331-e89e73853f31?q=80&w=2071&auto=format&fit=crop" 
          ...
          <h3 class="font-display text-2xl font-light mb-4">Our Community</h3>
          <p>
          ...
          <div class="my-10">
            <img 
              ...
              class="w-full h-auto rounded-sm"
            />
            <p class="text-sm text-center mt-2 text-gray-600">Our dedicated team of coffee professionals</p>
          </div>
          
          <h3 class="font-display text-2xl font-light mb-4">Looking Forward</h3>
          <p>
