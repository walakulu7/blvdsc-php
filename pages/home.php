    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <p class="text-gray-600 mb-6 leading-relaxed">
          Since 2019, BLVD Specialty Coffee has been Melbourne's premier destination for exceptional coffee experiences. We source our beans directly from sustainable farms around the world and roast them in small batches to ensure maximum freshness and flavor.
        </p>
